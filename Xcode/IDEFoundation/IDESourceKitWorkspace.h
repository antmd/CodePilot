...
/*
{
    IDESourceKitConnection *_conn;	// 8 = 0x8
    long long _indexerToken;	// 16 = 0x10
    IDEWorkspace *_workspace;	// 24 = 0x18
    DVTFilePath *_databaseFolder;	// 32 = 0x20
    DVTFilePath *_workspaceSettingIndexStoreFolderPath;	// 40 = 0x28
    BOOL _workspaceSettingEnabledFullStoreVisibility;	// 48 = 0x30
    IDEIndexingPrebuildController *_prebuildController;	// 56 = 0x38
    DVTDispatchLock *_stateLock;	// 64 = 0x40
    NSMutableDictionary *_identifiersToIndexables;	// 72 = 0x48
    NSMutableDictionary *_indexablesToProductHeaders;	// 80 = 0x50
    DVTObservingToken *_activeRunContextObservingToken;	// 88 = 0x58
    DVTObservingToken *_activeRunDestinationObservingToken;	// 96 = 0x60
    DVTNotificationToken *_indexableFileWasAddedNotificationObservingToken;	// 104 = 0x68
    DVTNotificationToken *_indexableFileWillBeRemovedNotificationObservingToken;	// 112 = 0x70
    DVTNotificationToken *_indexableDidRenameFileNotificationObservingToken;	// 120 = 0x78
    DVTNotificationToken *_buildablesDidChangeNotificationObservingToken;	// 128 = 0x80
    DVTNotificationToken *_buildSettingsDidChangeNotificationObservingToken;	// 136 = 0x88
    DVTNotificationToken *_buildOperationWillStartNotificationObservingToken;	// 144 = 0x90
    DVTNotificationToken *_buildOperationDidStopNotificationObservingToken;	// 152 = 0x98
    DVTNotificationToken *_prebuildNotificationToken;	// 160 = 0xa0
    DVTNotificationToken *_applicationIsQuittingNotificationToken;	// 168 = 0xa8
    DVTNotificationToken *_connectionInterruptedNotificationToken;	// 176 = 0xb0
    DVTNotificationToken *_connectionRestoredNotificationToken;	// 184 = 0xb8
    // Error parsing type: Ac, name: _connectionWasInterrupted
    DVTTimeSlicedMainThreadWorkQueue *_orderedMainThreadQueue;	// 200 = 0xc8
    long long _purgeCount;	// 208 = 0xd0
}
 */
